...
class Content_Helper extends Free_Content_Helper {
	...
	/**
	 * Check whether post is built with WordPress block editor.
	 *
	 * @param int $post_id ID of the post being checked.
	 *
	 * @return bool
	 ...
	 */
	public function output_content_using_builder( $post, $builder_name, $blog_switched = false, $original_blog_id = 1 ) {
	 ...
	 * @see wp-content/plugins/brizy/public/main.php
	 */
	public function prepare_breakdance_output( $post_id, $location = 'admin_page' ) {

		$breakdance_helper = new Breakdance_Helper( get_post( $post_id ) );
