...
".frm-show-form",validateForm);jQuery(document).on("frmFieldChanged",priceChanged);checkPriceFieldsOnLoad()});window.frmStripeLiteForm={readyToSubmitStripeLink:readyToSubmitStripeLink,processForm:function(cardElement,e,form){event=e;thisForm=form;processForm(cardElement)}}})();
