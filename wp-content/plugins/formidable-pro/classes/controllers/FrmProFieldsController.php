...
class FrmProFieldsController {
	...
	*/
		...
		foreach ( $post_data as $data ) {
			...
			if ( $on_current_page && FrmProFieldsHelper::is_field_visible_to_user( $current ) ) {
				if ( FrmAppHelper::is_not_empty_value( $value ) && $value !== false ) {
					$display_value  = self::maybe_use_option_label( $value, $current_field, $data_field );
	 ...
	 *
	 * @param string   $value
	 * @param stdClass $current_field
	 * @param stdClass $data_field
	 * @return string|false
	 */
	private static function maybe_use_option_label( $value, $current_field, $data_field ) {
