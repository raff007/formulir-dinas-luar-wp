...
if ( ! class_exists( 'BB_Mobile_Application_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class BB_Mobile_Application_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new BB_Mobile_Application_WPTT_WebFont_Loader( $url );
