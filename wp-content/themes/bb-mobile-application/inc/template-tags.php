 ...
 * Posts pagination.
 */
if ( ! function_exists( 'bb_mobile_application_pagination_settings' ) ) {
	function bb_mobile_application_pagination_type() {
		$bb_mobile_application_pagination_type = get_theme_mod( 'bb_mobile_application_pagination_settings', 'Numeric Pagination' );
		if ( $bb_mobile_application_pagination_type == 'Numeric Pagination' ) {
