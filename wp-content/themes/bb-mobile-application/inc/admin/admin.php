...
function bb_mobile_application_admin_theme_style() {
   wp_enqueue_style('bb-mobile-application-custom-admin-style', esc_url(get_template_directory_uri()) .'/inc/admin/admin.css');
}
 ...
 <div class="wrapper-info">
	 <div class="header">
		...
		<div class="main-button">
			...
			<a href="<?php echo esc_url( BB_MOBILE_APPLICATION_LIVE_DEMO ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'bb-mobile-application'); ?></a>
	...
	<div id="Home" class="tabcontent tab1">
	  	...
	  	<div class="sec-button">
			...
			<a href="<?php echo esc_url( BB_MOBILE_APPLICATION_CONTACT ); ?>" target="_blank"><?php esc_html_e('Support', 'bb-mobile-application'); ?></a>
